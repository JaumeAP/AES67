...
// PTPClockIdentity's toString() and fromMAC() were here. The type is declared
// in the core (NetworkEngine/PTP/PTPProtocolTypes.h) and its definitions now
// live there too, in PTPProtocolTypes.cpp: anything else that includes the
// header was linking against a definition inside this package.
