...
| [`packages/t41-ptp-fork`](packages/t41-ptp-fork) | IEEE 1588 for the Teensy 4.1, a fork of `IMS-AS-LUH/t41-ptp`, carrying QNEthernet and TimeLib under `libraries/`. A submodule: [`JaumeAP/t41-ptp`](https://github.com/JaumeAP/t41-ptp), the only package here that is a repository of its own | Arduino / PlatformIO |
